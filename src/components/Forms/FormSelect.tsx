    ...
    <div className="mb-5">
      ...
      <Controller
        ...
        render={({ field: { value, onChange } }) => (
          <select
            onChange={onChange}
            className={`px-1 md:px-2 lg:px-2 focus:outline-none w-full bg-transparent box-border text-black rounded border-2 border-solid border-gray-300 focus:border-[#0099ff] ${
              size === "lg" &&
